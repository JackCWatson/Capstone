...
class nmrpGUI(QtWidgets.QMainWindow):
    ...
    def setupTab2(self, font): ####################################
        ...
        self.label_PS.setMinimumSize(133, 31)
        ...
        self.port_label_PS.setMinimumSize(106, 31)
    ...
    def setupTab3(self, font): ####################################
        ...
        self.label_TR_1.setMinimumSize(134, 31)
        self.label_TR_1.setText("Enter the URL to ")
        ...
        self.trace_label_TR.setMinimumSize(105, 31)
        ...
        self.label_TR_2.setMinimumSize(94, 31)
        ...
        self.ttl_label_TR.setMinimumSize(148, 31)
    ...
    def setupTab4(self, font): ####################################
        ...
        self.label_ST.setMinimumSize(133, 31)
        ...
        self.speed_label_ST.setMinimumSize(106, 31)
    ...
    def pressed_runNSButton(self):
        ...
        self.table_results_NS.horizontalHeader().setSectionResizeMode(2, QtWidgets.QHeaderView.ResizeToContents)
